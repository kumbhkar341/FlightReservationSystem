...
public class RouteDao {
	...
	public int save(Route p){    
	    String sql="insert into frs_tbl_route(Source,Destination,TravelDuration,Faree) values('"+p.getSource()+"','"+p.getDestination()+"','"+p.getTravelDuration()+"','"+p.getFaree()+"')";    
	    return template.update(sql);    
	}    
	public int update(Route p){    
	    String sql="update frs_tbl_route set Source='"+p.getSource()+"', Destination='"+p.getDestination()+"',TravelDuration='"+p.getTravelDuration()+"',Faree='"+p.getFaree()+"' where RouteId="+p.getRouteId()+"";    
	    return template.update(sql);    
	}    
	public int delete(int RouteId){    
	    String sql="delete from frs_tbl_route where RouteId="+RouteId+"";    
	    return template.update(sql);    
	}    
	public Route getRouteById(int RouteId){    
	    String sql="select * from frs_tbl_route where RouteId=?";    
